...
BUILD_DIR: str = os.environ.get('CMAKE_CURRENT_BINARY_DIR')
RES_DIR: str = os.path.join(BUILD_DIR, "res")
GEN_DIR: str = os.path.join(BUILD_DIR, "generated")
...
class Test24pxIcons(unittest.TestCase):

    def test_reverse24pxconversion(self):
        self.maxDiff = None
