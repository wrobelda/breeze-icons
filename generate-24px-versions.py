            ...
            if os.path.islink(filepath):
                ...
                if (width_height_matched_or_none and viewBox_matched_or_none
                    ...
                    if not viewBox_matched_or_none:
                        ...
                        skipped_message += "viewBox and width or height are missing!"
                    else:
                        skipped_message += "You shouldn't be seeing this. Fix " + os.path.basename(sys.argv[0])

                    print(filepath + skipped_message)
